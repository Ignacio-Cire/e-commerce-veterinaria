    ...
    <footer class="text-center text-white bg-warning">
        <div class="container p-4 pb-2">
            <div class="row text-center">
                <div class="col">
                    <a href="https://github.com/Ignacio-Cire"><h5><i class="fa-brands fa-github"></i></h5></a>
                    <h5>Ignacio Cire</h5>
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            Programación Web Dinámica - 2024 <img src="./img/logo.png" class="mx-2" alt="FAI" title="FAI" width="40" height="40"> Universidad Nacional del Comahue
        </div>
    </footer>
</section>
